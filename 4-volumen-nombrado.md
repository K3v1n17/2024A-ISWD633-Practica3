...
```
docker run -d --name client-postgres --publish published=9500,target=80 -e PGADMIN_DEFAULT_PASSWORD=54321 -e PGADMIN_DEFAULT_EMAIL=kevin@example.com --network net-drupal dpage/pgadmin4
```
...
![Imagen](imagenes/server-drupal.png)
